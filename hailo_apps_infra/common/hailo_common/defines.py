...
INSTALLATION_ROOT = PACKAGE_ROOT / HAILO_INSTALLATION_MODULE
GSTREAMER_ROOT = PACKAGE_ROOT / HAILO_GSTREAMER_MODULE
PIPELINES_ROOT = PACKAGE_ROOT / HAILO_PIPELINES_MODULE
...
GST_AUTO_VIDEO_SINK = "autovideosink"
